...
public class Axe implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, @NotNull Command command, String s, String[] args) {
        sender.sendMessage(ChatColor.AQUA+"도끼의 최대 마법부여 + 마법부여대 사용 가능 여부:");
        ...
        sender.sendMessage(ChatColor.GOLD+"행운 Fortune   3(III) "+ ChatColor.GREEN+"  (O)");
        ...
        sender.sendMessage(ChatColor.AQUA+"추가 마법부여 + 마법부여대 사용가능 여부: ");
        sender.sendMessage(ChatColor.GOLD+"섬세한 손길 Silk Touch   1(I) "+ ChatColor.GREEN+"  (O)");
