...
public class Leggings implements CommandExecutor {

    @Override
    public boolean onCommand(CommandSender sender, @NotNull Command command, String s, String[] args) {
        sender.sendMessage(ChatColor.AQUA+"레깅스의 최대 마법부여 + 마법부여대 사용 가능 여부:");
        ...
        sender.sendMessage(ChatColor.GOLD+"신속한 잠행 Swift Sneak   3(III) "+ ChatColor.GREEN+"  (X)");
